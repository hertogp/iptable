...
void
test_key_isin_ipv4(void)
{
    // key_isin(a, b, m) --> true iff a & m == b & m
    ...
    mu_assert(key_isin(a, b, m));
    mu_assert(key_isin(b, a, m));
    ...
    a[3] = b[3] = 0x03;
    a[4] = b[4] = 0x04;
    m[1] = m[2] = m[3] = m[4] = 0xff; // just in case upper code changes

    mu_assert(key_isin(a, b, m));
    mu_assert(key_isin(b, a, m));

    // 1.2.3.4 !isin 1.2.3.3/30
    a[1] = b[1] = 0x01;
    a[2] = b[2] = 0x02;
    a[3] = b[3] = 0x03;
    a[4] = 0x04; b[4] = 0x03;
    m[1] = m[2] = m[3] = 0xff; // just in case upper code changes
    m[4] = 0xfd;

    mu_false(key_isin(a, b, m));
    mu_false(key_isin(b, a, m));

    // 1.2.3.0 isin 1.2.3.0/31
    // 1.2.3.1 isin 1.2.3.0/31
    // 1.2.3.2 !isin 1.2.3.0/31
    a[1] = b[1] = 0x01;
    a[2] = b[2] = 0x02;
    a[3] = b[3] = 0x03;
    a[4] = 0x00; b[4] = 0x00;
